  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="showContact/{{ $data->id }}" style="background-color: rgb(79, 234, 154);;
            color: rgb(14, 11, 11);
            padding: 14px 25px;
            text-align: center;
        ...
        <td><a href="deleteContact/{{ $data->id }}" onclick="return confirm('Are you sure you want to delete?')" style="
